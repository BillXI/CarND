...
public:
  ...
  /**
   * Following are the helper function borrowed from the exercise
   */
  ...
  void UpdateState(MatrixXd &Zsig, MatrixXd &S, VectorXd &z_pred, VectorXd &z, VectorXd *x_out, MatrixXd *P_out);
